            ...
            <div class="main-footer-inner">
              ...
              <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                <div class="mcare-foot-address footer-box">
                  ...
                  <p class="text-content"><i class="fa fa-envelope"></i><a href="mailto:meditreat@meditreat.com">blagerman@cardiopuls.com</a></p>
                  <p class="text-content"><i class="fa fa-phone"></i>703-217-3169 </p>
                <ul class="foot-social" style="margin-left: -15px;">
                  <li>
